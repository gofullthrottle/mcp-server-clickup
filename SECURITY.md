...
2. Send details of the vulnerability to the project maintainer directly at [create a private security report](https://github.com/YOUR_GITHUB_USERNAME/clickup-remote-mcp-server/security/advisories/new).
