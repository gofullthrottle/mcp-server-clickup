...
let customFieldService = null;
function getCustomFieldService() {
...
export async function handleCustomFieldTool(toolName, args) {
    ...
    switch (toolName) {
        case 'clickup_custom_field_get_definitions': {
            ...
            const result = await service.getWorkspaceCustomFields(validated.space_id, validated.folder_id, validated.list_id);
            return {
                fields: result.all,
        ...
        case 'clickup_custom_field_set_value': {
            ...
            const result = await service.setCustomFieldValue(validated.task_id, validated.field_id, validated.value, validated.field_type, validated.use_custom_task_ids || false);
            return {
        ...
        case 'clickup_custom_field_remove_value': {
            ...
            await service.removeCustomFieldValue(validated.task_id, validated.field_id, validated.use_custom_task_ids || false);
            return {
                task_id: validated.task_id,
                field_id: validated.field_id,
        ...
        case 'clickup_custom_field_find_by_name': {
            ...
            const field = await service.findCustomFieldByName(validated.list_id, validated.field_name);
            if (!field) {
                return {
                    found: false,
        ...
        case 'clickup_custom_field_set_by_name': {
            ...
            await service.setCustomFieldValue(validated.task_id, field.id, validated.value, field.type, validated.use_custom_task_ids || false);
            return {
                task_id: validated.task_id,
                field: {
                    id: field.id,
