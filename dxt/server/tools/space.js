...
export async function handleSpaceTool(toolName, args, spaceService) {
    switch (toolName) {
        ...
        case 'clickup_space_toggle_feature': {
            ...
            const space = await spaceService.toggleSpaceFeature(validated.space_id, validated.feature, validated.enabled);
            return sponsorService.createResponse({
                id: space.id,
                name: space.name,
