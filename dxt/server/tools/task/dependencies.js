...
export async function handleDependencyTool(toolName, args) {
    switch (toolName) {
        case 'clickup_task_add_dependency': {
            ...
            const result = await taskService.addDependency(validated.task_id, validated.depends_on, validated.dependency_of, validated.use_custom_task_ids || false);
            return {
                task_id: result.id,
        ...
        case 'clickup_task_remove_dependency': {
            ...
            await taskService.removeDependency(validated.task_id, validated.depends_on, validated.dependency_of, validated.use_custom_task_ids || false);
            return {
                message: validated.depends_on
        ...
        case 'clickup_task_get_dependencies': {
            ...
            const result = await taskService.getTaskDependencies(validated.task_id, validated.use_custom_task_ids || false);
            return {
        ...
        case 'clickup_task_add_link': {
            ...
            const result = await taskService.addTaskLink(validated.task_id, validated.links_to, validated.use_custom_task_ids || false);
            return {
                task_id: result.id,
                task_name: result.name,
                linked_tasks: result.linked_tasks || [],
        ...
        case 'clickup_task_remove_link': {
            ...
            await taskService.removeTaskLink(validated.task_id, validated.links_to, validated.use_custom_task_ids || false);
            return {
