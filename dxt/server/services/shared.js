...
export const { list: listService, task: taskService, folder: folderService, workspace: workspaceService, timeTracking: timeTrackingService, document: documentService, space: spaceService, project: projectService } = clickUpServices;
